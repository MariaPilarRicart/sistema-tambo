...
export function EmployeeDashboard({
  ...
  const cards = [
    ...
    },
    {
      ...
      subtitle: 'Partos programados actuales.',
      tone: 'indigo' as MetricTone,
      icon: Baby,
      url: buildUrl(paths.agenda, { estado: 'PROGRAMADA', tipo: 'PARTO' }),
    },
    {
      title: 'Tactos programados',
      value: formatNumber(resumen.tactosPendientes),
      subtitle: 'Tactos programados actuales.',
      tone: 'emerald' as MetricTone,
      icon: Stethoscope,
      url: buildUrl(paths.agenda, { estado: 'PROGRAMADA', tipo: 'TACTO' }),
    },
    {
      title: 'Secados programados',
      value: formatNumber(resumen.secadosPendientes),
      subtitle: 'Secados programados actuales.',
      tone: 'blue' as MetricTone,
      icon: ClipboardCheck,
      url: buildUrl(paths.agenda, { estado: 'PROGRAMADA', tipo: 'SECADO' }),
    },
    {
      ...
      tone: 'pink' as MetricTone,
      icon: Syringe,
      url: buildUrl(paths.vaccination, { estado: 'PENDIENTE' }),
    },
    {
