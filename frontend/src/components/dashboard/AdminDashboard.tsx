...
export function AdminDashboard({
  ...
  const cards = [
    {
      title: 'Retiros de leche',
      value: formatNumber(resumen.resumenVentas.cantidadRetiros),
      subtitle: 'Retiros registrados en el período.',
    ...
    },
    {
      ...
      value: formatCurrency(resumen.resumenVentas.importeLiquidado),
      subtitle: 'Total liquidado en el período.',
    ...
    },
    {
      ...
      value: formatNumber(resumen.resumenVentas.litrosEntregados, ' L'),
      subtitle: 'Litros de leche retirados en el período.',
      tone: 'pink' as MetricTone,
      icon: BarChart3,
      url: buildUrl(paths.sales, { section: 'retiros', ...periodParams }),
    },
    {
      title: 'Pendientes de liquidar',
      value: formatNumber(resumen.resumenVentas.pendientesDeLiquidar),
