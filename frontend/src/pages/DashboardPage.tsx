...
export function DashboardPage({ authToken, onUnauthorized }: DashboardPageProps) {
  ...
  return (
    <div className="dashboard-page">
      <section className="dashboard-toolbar">
        <div>
          <p>Indicadores reales de animales, eventos y agenda.</p>
        </div>
        <button type="button" className="secondary-button dashboard-refresh-button" onClick={() => void loadDashboard()} aria-label="Actualizar dashboard">
          <RefreshCcw size={18} />
          Actualizar
        </button>
      </section>
